...
namespace Vulns.Jobs.Weaknesses
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("MitreCweViewTypeEnumeration", Namespace="http://cwe.mitre.org/cwe-6")]
    public enum MitreCweMitreCweViewTypeEnumeration
    {
