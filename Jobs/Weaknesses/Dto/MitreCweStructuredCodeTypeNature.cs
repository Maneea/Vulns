...
namespace Vulns.Jobs.Weaknesses
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("MitreCweStructuredCodeTypeNature", Namespace="http://cwe.mitre.org/cwe-6", AnonymousType=true)]
    public enum MitreCweMitreCweStructuredCodeTypeNature
    {
        ...
        [System.Xml.Serialization.XmlEnumAttribute("mitigation")]
        Mitigation,
        
        [System.Xml.Serialization.XmlEnumAttribute("result")]
        Result,
    }
}
