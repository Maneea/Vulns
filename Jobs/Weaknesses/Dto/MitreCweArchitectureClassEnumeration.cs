...
namespace Vulns.Jobs.Weaknesses
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ArchitectureClassEnumeration", Namespace="http://cwe.mitre.org/cwe-6")]
    public enum MitreCweArchitectureClassEnumeration
    {
